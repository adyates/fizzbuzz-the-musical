...
public class FizzBuzz {
	/**
	 * The classic Fizz Buzz function. Given a ceiling, builds the printable
	 * string in classic FizzBuzz format for the numbers [1, ceiling) and
	...
	public StringBuilder sodaBee(int ceiling) {
		...
		SodaBuzzFactory factory = new SodaBuzzFactory();
		for (int nextNum = 1; nextNum <= ceiling; nextNum++) {
			sb.append(factory.makeSodaBee(nextNum));
		}
